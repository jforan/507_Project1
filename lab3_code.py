...
# HINT: check out the built-in Python function is instance or the Python function type (either of which you could use in different ways to solve this problem)!
